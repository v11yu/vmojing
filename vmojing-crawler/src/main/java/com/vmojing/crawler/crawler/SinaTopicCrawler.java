...
public class SinaTopicCrawler implements Runnable{
	/**失败后的重试次数 */
	private static final Integer TRY_TIME = 3;
	/**单次抓取的页数 */
	private static final Integer PAGE_NUM = 5;
	private static final Logger log = LoggerFactory.getLogger(SinaTopicCrawler.class);
	private String topicNames;
	private TopicFetcher topicFetcher;
	/**
	 * @param topicNames 需要爬取的话题Name，用半角逗号分隔
	 */
	public SinaTopicCrawler(String topicNames){
